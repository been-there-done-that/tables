        ...
        <div class="w-64 flex flex-col bg-muted/10 p-4 space-y-4">
            <div>
                ...
                <p class="text-xs text-muted-foreground">
                    1. Ensure you have an active connection. 2. Type a query. 3.
                    Suggestions should appear triggered by space, dot, or
                    typing.
                </p>
            </div>
            ...
            <div class="flex-1 overflow-hidden flex flex-col">
                ...
                <div
                    class="flex-1 overflow-auto bg-muted/20 p-2 rounded text-[10px] font-mono border border-border"
                >
                    {#each logs as l}
